...
@interface ZFWKWebViewController ()<WKNavigationDelegate,WKScriptMessageHandler,WKUIDelegate,UIImagePickerControllerDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate>
...
- (void)viewDidLoad {
    ...
    // 配置网页的配置文件
       ...
       NSString * urlStr = [[NSBundle mainBundle] pathForResource:@"finalVue.html" ofType:nil];
